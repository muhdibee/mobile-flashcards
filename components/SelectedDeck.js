...
class SelectedDeck extends React.Component {
    ...
    render() {
        ...
        <View style={[appStyles.container, {justifyContent: 'space-around', flex: 1}]}>
            ...
            <View style={[appStyles.container, {justifyContent: 'flex-start', flex: 1}]}>
                <Button style={{flex: 1, margin: 10, padding: 10}} title='Add Card' />
                <Button style={{flex: 1, margin: 10, padding: 10}} title='Start Quiz' />
                <Text style={{flex: 1, padding: 10, margin: 10}} >Delete Deck</Text>
            </View>
        </View>
        )
    }
